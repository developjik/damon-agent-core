...
const I18N = {
  ko: {
    ...
    "hero.lead": "Damon은 Claude Code·Codex CLI·Oh My Pi·Cursor·Amp·Kimi·Qwen·Gemini를 각자의 네이티브 CLI로 구동하는 Rust 상주 데몬입니다. 모델·툴·인증은 에이전트 몫 — Damon은 세션, 권한 릴레이, 검색 가능한 히스토리, 채팅 채널, 어디서든 접근을 소유합니다.",
    ...
    "strip.title": "PATH에 있으면 자동 등록 — 여덟 개 네이티브 백엔드",
  ...
  en: {
    ...
    "hero.lead": "Damon is a resident Rust daemon that drives Claude Code, Codex CLI, Oh My Pi, Cursor, Amp, Kimi, Qwen, and Gemini through their native CLIs. Model, tools, and auth belong to the agents — Damon owns sessions, permission relaying, searchable history, chat channels, and from-anywhere access.",
    ...
    "strip.title": "On PATH, self-registered — eight native backends",
...
const NODES = {
  ...
  agents: [
    ...
    { name: { ko: "Gemini CLI", en: "Gemini CLI" },
      desc: { ko: "Google 코딩 에이전트", en: "Google's coding agent" },
